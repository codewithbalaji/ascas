...
export function HighlightsSection() {
  ...
  }, [targetCounts.consultations, targetCounts.appointments, targetCounts.scans, targetCounts.fertility, targetCounts.experience]);
    ...
    <section className="py-20">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          >
            <div className="text-2xl font-bold text-pink">{counts.consultations}+</div>
          ...
          <motion.div
            ...
            className="text-center"
          >
            <div className="text-2xl font-bold text-pink">{counts.appointments}+</div>
          ...
          <motion.div
            ...
            className="text-center"
          >
            <div className="text-2xl font-bold text-pink">{counts.scans}+</div>
          ...
          <motion.div
            ...
            className="text-center"
          >
            <div className="text-2xl font-bold text-pink">{counts.fertility}+</div>
          ...
          <motion.div
            ...
            className="text-center"
          >
            <div className="text-2xl font-bold text-pink">{counts.experience}+</div>
